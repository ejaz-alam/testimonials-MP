...
class TemplateListing extends \Magento\Framework\View\Element\Template
{
     ...
     protected function _prepareLayout()
        {
            ...
            for ($i=1; $i < 4; $i++) {
             ...
             if ($this->getPosts()) {
            $pager = $this->getLayout()->createBlock( 'Magento\Theme\Block\Html\Pager', 'pme.testimonials' )->setAvailableLimit($limArray)->setShowPerPage(true)->setCollection( $this->getPosts() );
